...
const pricingCardVariants = cva("rounded-lg p-4 py-6 w-full", {
    variants: {
        variant: {
            ...
            highlight: "bg-liner-to-br from-[#093C23] to-[#051B16] text-white",
        }
    },
    defaultVariants: {
        variant: "default",
    ...
    return (
        <div className={cn(pricingCardVariants({ variant }), className, "border")}>
            <div className="flex items-end gap-x-4 justify-between">
                ...
                <div className="flex items-end shrint-0 gap-x-0.5">
            ...
            <div className="flex flex-col gap-y-2 mt-6">
                ...
                <ul
                    className={
                        cn("flex flex-col gap-y-2.5", pricingCardSecondaryTextVariants({ variant }))
                }
                >
                    {
