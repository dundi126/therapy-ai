    ...
    return (
        <div className="flex-1 py-4 px-4 md:px-8 flex flex-col gap-y-10">
            <div className="mt-4 flex-1 flex flex-col gap-y-10 items-center">
                <h5 className="font0medium text-2xl md:text-3xl">
                    You are on the {" "}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {
                        products.map((product) => {
                            const isCurrent = product.id === currentSubscription?.id
                            ...
                            return (
                                <PricingCard
                                    ...
                                    title={product.name}
                                    variant={
                                        product.metadata.variant === 'highlight' ? 'highlight' : 'default'
                                    }
                                    price={
